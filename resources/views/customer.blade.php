...
@section('content')
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#exampleModal" onclick="New();$('#customer')[0].reset();">
                                Agregar
                            </button>
                            <p></p>
                            Buscar
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="" method="post" role="form" id="customer" name="form">
                                                ...
                                                {{ csrf_field() }}
                                                Dni :      <input type="number" name="dni" id="dni"
                                                class="form-control">
                                                Apellido Paterno :      <input type="text" name="firstname" id="firstname"
                                                class="form-control">
                                                Apellido Materno :      <input type="text" name="lastname" id="lastname"
                                                class="form-control">
                                                Nombres :      <input type="text" name="name" id="name"
                                                class="form-control">
                                                Celular :      <input type="number" name="cellphone" id="cellphone"
                                                class="form-control">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="button" value="Guardar" class="btn btn-success"id="create"
                                                onclick="customerStore()" name="create">
                                            <input type="button" value="Modificar" class="btn btn-danger"id="update"
                                                onclick="customerUpdate();" name="update">
